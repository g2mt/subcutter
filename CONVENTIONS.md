...
- Unless the user explicitly gives it to you, *DO NOT* read the specs file apart from this *Conventions* document.

- When commiting, do not add anything to the message body. Summarize what the commit does within only the commit title.
Do not look at prior git log. Commit using the conventional commit format: `<type>: <description>`
